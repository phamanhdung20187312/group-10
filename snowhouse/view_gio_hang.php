                ...
                <div class="row">
                    <div class="col">
                        ...
                        <form action="process_dat_hang.php" method="post">
                            <table class="table">
                                <tr>
                                    <td><button class="btn btn-light">Mượn sách</button></td>
                                    <td><button class="btn btn-light"><a style="color: black" href="process_xoa_gio_hang.php">Xóa</a></button></td>
                                    <td><button class="btn btn-light"><a style="color: black" href="index.php">Tiếp tục xem sách</a></button> </td>
                                </tr>
                            </table>
                        </form>
                    </div>
